                            ...
                            <div class="col s12 m12 l4">
                                <ul id="task-card" class="collection with-header">
                                    ...
                                    <li class="collection-item dismissable">
                                        ...
                                        <label for="task1">Create Mobile App UI. <a href="index.html#" class="secondary-content"><span class="ultra-small">Today</span></a>
                                        </label>
                                        <span class="task-cat teal">Mobile App</span>
                                    </li>
                                    <li class="collection-item dismissable">
                                        <input type="checkbox" id="task2" />
                                        <label for="task2">Check the new API standerds. <a href="index.html#" class="secondary-content"><span class="ultra-small">Monday</span></a>
                                        </label>
                                        <span class="task-cat purple">Web API</span>
                                    </li>
                                    <li class="collection-item dismissable">
                                        <input type="checkbox" id="task3" checked="checked" />
                                        <label for="task3">Check the new Mockup of ABC. <a href="index.html#" class="secondary-content"><span class="ultra-small">Wednesday</span></a>
                                        </label>
                        ...
                        <div class="row">
                            ...
                            <div class="col s12 m12 l4">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-content">
                                        <p class="row">
                                          <span class="left"><a href="index.html">Web Design</a></span>
                                          <span class="right">18th June, 2015</span>
                                        </p>
                                        <h4 class="card-title grey-text text-darken-4"><a href="index.html#" class="grey-text text-darken-4">Materialize Featured Blog Post Card</a>
                                        </h4>                                        
                                        <div class="row">
                                          <div class="col s2">
                                            <img src="images/avatar.jpg" alt="" class="circle responsive-img valign profile-image">
                                          </div>
                                          <div class="col s9"> By <a href="index.html#">John Doe</a></div>
                                        </div>
                                    </div>
                                    <div class="card-reveal">
                            ...
                            <div class="col s12 m12 l4">
                                <div class="product-card">
                                    <div class="card">
                                        <div class="card-image waves-effect waves-block waves-light">
                                            <a href="index.html#" class="btn-floating btn-large btn-price waves-effect waves-light  pink accent-2">$189</a>
                                        ...
                                        <div class="card-content">
                                            ...
                                            <div class="row">
                                                <div class="col s8">
                                                    <p class="card-title grey-text text-darken-4"><a href="index.html#" class="grey-text text-darken-4">Featured Product of The Month</a>
                                                    </p>
                                                </div>
                                                <div class="col s4 no-padding">
                                                    <a href="index.html"></a><img src="images/amazon.jpg" alt="amazon" class="responsive-img">
                                ...
                                <div class="map-card">
                                    <div class="card">
                                        ...
                                        <div class="card-content">                    
                                            ...
                                            <h4 class="card-title grey-text text-darken-4"><a href="index.html#" class="grey-text text-darken-4">Company Name LLC</a>
                                            </h4>
                            ...
                            <div class="col s12 m12 l6">
                                <ul id="projects-collection" class="collection">
                                    <li class="collection-item avatar">
                                        ...
                                        <p>Your Favorites</p>
                                        <a href="index.html#" class="secondary-content"><i class="mdi-action-grade"></i></a>
                                    </li>
